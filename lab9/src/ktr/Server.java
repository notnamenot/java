...
//            num=true;
    ...
    public void disconnect(int id, boolean status) {
        ...
        String message = "";
        if (status) {
            message = "username: " + c.getName().toString() + " || ID: " + c.getID() + " || IP: " + c.getAddress().toString() + " || port: " + c.getPort() + " || Status: disconnected";
            message = "username: " + c.getName().toString() + " || ID: " + c.getID() + " || IP: " + c.getAddress().toString() + " || port: " + c.getPort() + " || Status: disconnected";
            String string = c.getName().toString() + "/i/" + c.getID();
//            System.out.println(string);
            sendToAll("/d/" + string + "/e/");
        } else {
            message = "username: " + c.getName().toString() + " || ID: " + c.getID() + " || IP: " + c.getAddress().toString() + " || port: " + c.getPort() + " || Status: Timed Out";
        }
